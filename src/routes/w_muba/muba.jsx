...
import { slides } from "./data_muba.jsx"
...
const Muba = () => {
    ...
    const work_item = {
        ...
        year : '2019',
        mode : 'Competitions | Museum',
        team : 'Arch. Veronica Schiaroli, Ing. Daniele Mazza, Ing. Massimo Di Marco, Dott. Giuseppe Ciro De Gregorio',
        status: '2nd place | Design',
        slides: slides,
        description : [
