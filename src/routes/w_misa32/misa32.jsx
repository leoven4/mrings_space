  ...
  return(
    <div>
        ...
        <div className="image_gallery">
            ...
            <Images
                data={work_item['slides'].slice(0,4)}
                onClick={(currentIndex) => setIndex(currentIndex)}
            />

            <p className="subtitle">the green paradise</p>
            ...
            <Images
                data={work_item['slides'].slice(4,9)}
                onClick={(currentIndex) => setIndex(currentIndex)}
            />

            <p className="subtitle">elegance on top</p>
            ...
            <Images
                data={work_item['slides'].slice(11,17)}
                onClick={(currentIndex) => setIndex(currentIndex)}
            />

            <p className="subtitle">the exotic venue</p>
